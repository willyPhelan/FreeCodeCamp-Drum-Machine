...
const DrumControl = ({ stop, power, name, handleVolume, volume, changeSoundsGroup }) => {
  return /*#__PURE__*/(
    ...
    React.createElement("button", { onClick: stop }, "Turn ", power ? 'Off' : 'On'), /*#__PURE__*/
    React.createElement("h2", { id: "display" }, name), /*#__PURE__*/
    React.createElement("h2", { className: "vol" }, "Volume: ", Math.round(volume * 100), "db"), /*#__PURE__*/

    React.createElement("button", { onClick: changeSoundsGroup }, "Change Sounds "), /*#__PURE__*/
